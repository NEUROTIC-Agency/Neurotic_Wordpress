<a href="<?php echo $url ?>">
  <div class="flex flex-col justify-between w-full h-full p-6 bg-white border border-gray-200 rounded-lg shadow">
    <div>
      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900"><?php echo $title ?></h5>
      <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><?php echo $excerpt ?></p>
    </div>
